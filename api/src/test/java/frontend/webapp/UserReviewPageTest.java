...
class UserReviewPageTest {
    ...
    void setUp() throws ParseException, ExceptionDetails {
        ...
        controller.clickButton("reviewUserButton1");
    }
    ...
    /*
    @Test
    void whenReviewingUser_Twice_showError() {
        ...
        assertTrue(controller.checkText("errorBlowjob", "You can't review yourself, or the same user more than once, silly!"));
    }
    */
    ...
    void whenValidScore_goBackToProfile() {
        ...
        String url = "http://localhost:" + port + "/user/oof";
        assertTrue(controller.checkURL(url));
    }

    @Test
    void whenReviewingSelf_showError() {
        controller.login(port);
